...
<!-- Mirrored from htmldemos.ruventhemes.com/desmond-resume/light/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Dec 2017 19:03:44 GMT -->
<head>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/vue-resource/0.1.13/vue-resource.min.js"></script>
    ...
    <body>
      ...
      <header id="navHeader" class="slide-header">
        <div id="app" class="slide-header-content">
  
<div id="my_view">
    <h1> {{ data.data.task_url}}</h1>
    {{ data.data.task}}
<!--    <img src="{{ data.data.task_screenshots}}"> -->
        ...
        <div class="c-main-container  js-main-container">
           ...
           <?php include 'layout/summary.php'; ?>
...
<script type="text/javascript">
  ...
  $(window).scroll(function(){
    ...
    if(winTop >= 30){
      ...
      if(winTop >= 600){
         $("#appear").removeClass("offset");
     }
    }else{
      $("body").removeClass("sticky-header");
        $("#appear").addClass("offset");
    }//if-else
  });//win func.
...
<!-- Mirrored from htmldemos.ruventhemes.com/desmond-resume/light/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Dec 2017 19:04:53 GMT -->
</html>
